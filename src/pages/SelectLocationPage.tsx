...
const SelectLocationPage = () => {
  ...
  return (
    <div className="h-screen w-full bg-white flex flex-col overflow-hidden">
      ...
      {/* Soft colorful gradient background at top — matching Figma's blurred overlay look */}
      <div
      ...
      <button
        onClick={() => navigate(-1)}
        className="relative z-10 bg-transparent border-none cursor-pointer p-0 self-start"
        style={{ marginLeft: '25px', marginTop: '56px' }}
        aria-label="Go back"
      >
      ...
      <h1
        className="relative z-10 text-center text-[#181725] font-semibold mt-4 px-6"
      ...
      {/* Subtitle */}
      <p
        className="relative z-10 text-center text-[#7C7C7C] font-medium mt-3 px-10"
      ...
      <div className="relative z-10 px-6 mb-5">
        ...
        <div className="relative">
          <button
            ...
            className="w-full flex items-center justify-between bg-transparent border-none cursor-pointer p-0 pb-3 border-b border-[#E2E2E2]"
          >
            <span className="font-medium text-[#181725]" style={{ fontSize: '18px', lineHeight: '29px' }}>
              {zone}
            </span>
            <svg width="12" height="8" viewBox="0 0 12 8" fill="none" aria-hidden="true">
              <path d="M1 1l5 6 5-6" stroke="#7C7C7C" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
          {zoneOpen && (
            <div className="absolute left-0 right-0 bg-white border border-[#E2E2E2] rounded-[10px] shadow-lg z-20 bottom-full mb-1">
              {zones.map((z) => (
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-[#181725] bg-transparent border-none cursor-pointer hover:bg-[#F2F3F2]"
                  style={{ fontSize: '16px' }}
                >
                  {z}
                </button>
      ...
      <div className="relative z-10 px-6 mb-6">
        ...
        <div className="relative">
          <button
            ...
            className="w-full flex items-center justify-between bg-transparent border-none cursor-pointer p-0 pb-3 border-b border-[#E2E2E2]"
          >
            <span className="font-medium" style={{ fontSize: '18px', lineHeight: '29px', color: area ? '#181725' : '#B1B1B1' }}>
