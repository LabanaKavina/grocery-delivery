...
const HomePage = () => {
  ...
  return (
    <div className="px-4 py-6 space-y-6">
      {/* Location header — Figma: carrot icon top center, pin + location text below */}
      ...
      {/* Groceries section with category cards */}
      <section aria-label="Groceries">
        ...
        {/* Category cards — Figma: 248×105, image left, label right, bg opacity 0.15 */}
        <div className="flex gap-4 mb-4 overflow-x-auto scrollbar-hide pb-1">
          {[
            {
              cat: ProductCategory.Pulses,
              bg: '#F8A44C',
              label: 'Pulses',
              img: 'https://images.unsplash.com/photo-1515543904379-3d757afe72e4?w=150&q=80',
            },
            {
              cat: ProductCategory.Rice,
              bg: '#53B175',
              label: 'Rice',
              img: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=150&q=80',
            },
            {
              cat: ProductCategory.BakerySnacks,
              bg: '#D3B0E0',
              label: 'Bakery',
              img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=150&q=80',
            },
            {
              cat: ProductCategory.DairyEggs,
              bg: '#FFC107',
              label: 'Dairy',
              img: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=150&q=80',
            },
            ...
            return (
              <button
                ...
                className="shrink-0 relative flex items-center rounded-[18px] cursor-pointer border-none overflow-hidden"
              ...
              >
                ...
                <div
                  ...
                  style={{ background: bg, opacity: isSelected ? 0.3 : 0.15 }}
                />
                {/* Product image — left side, 72×72 */}
                <img
                  src={img}
                  alt={label}
                  className="relative z-10 object-contain"
                  style={{ width: '72px', height: '72px', marginLeft: '17px' }}
                />
                {/* Label — right side */}
                <span
                  className="relative z-10 font-semibold text-[#3E423F]"
                  style={{ fontSize: '20px', lineHeight: '25px', marginLeft: '16px' }}
                >
                  {label}
                </span>
              </button>
